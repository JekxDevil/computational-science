...
% Despite often the situations requiring modeling are nonlinear,
% linear programming is appealing because of the advanced state of the software,
% guaranteed convergence to global minimum,
% and the fact that uncertainty in the model makes linear model more appropriate 
% than an overly complex nonlinear model.

Linear programs are usually stated and analyzed in the following \textit{standard form}:
