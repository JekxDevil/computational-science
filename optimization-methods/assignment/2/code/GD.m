...
[x_star, f_vals, grad_norms, iters, steps] = ...
    steepest_descent(x0, f_rosenbrock_sym, max_iters, tol, alpha_tilde, rho, c);
...
function [x_star, funcvals, gradient_norms, iters, steps] = ...
    steepest_descent(start_point, f_sym, max_iters, tol, alpha_tilde, rho, c)
