...
% rewrites maximisation or minimisation input problems in standard form.
%
% inputs:
% - type    = problem type, either 'max' or 'min'
% - A       = coefficient matrix
% - h       = right hand side of constraints
% - c       = vector of coefficients
% - m       = number of constraints
% - sign    = sign of inequality, either '1' for >= or '-1' for <=
%
