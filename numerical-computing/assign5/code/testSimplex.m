% This script has the purpose of testing your implementation 
% of the Simplex Method. 
% In case there should be any issue with your solution, you will 
% get an error and the code will stop. 
% If your proposed solution passes all the tests, 
% you can happily move to the next part of the assignment.
